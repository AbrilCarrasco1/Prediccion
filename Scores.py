...
st.image("cali1.jpg", caption="Predicción de la calificación.")

st.header('Datos')

def user_input_features():
  # Entrada
  Horas_Estudiadas = st.number_input('Horas estudiadas:', min_value=0.0, max_value=100.0, value = 0.0, step = 1.0)
  Horas_de_sueño = st.number_input('Horas de sueño:',  min_value=0.0, max_value=100.0, value = 0.0, step = 1.0)
  Asistencia = st.number_input('Asistencia:', min_value=0.0, max_value=230.0, value = 0.0, step = 1.0)
  Calificacion_previa  = st.number_input('Calificación previa:', min_value=0.0, max_value=140.0, value = 0.0, step = 1.0)
  ...
  user_input_data = {'hours_studied': Horas_Estudiadas,
                     ...
                     'previous_scores': Calificacion_previa,
                    }
